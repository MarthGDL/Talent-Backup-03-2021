...
namespace MVPStudio.Framework.Extensions
{
    public static class WebDriverExtension
    {
        ...
        public static IWebElement WaitForElement(this IWebDriver driver, By by, int timeOutinSeconds = 15)
        {
            try
            {
        ...
        public static void WaitForPageLoaded(this IWebDriver driver, string pageTitle, int timeOutinSeconds = 15)
        {
            try
            {
                var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(timeOutinSeconds));
        ...
        /// <param name="timeOutinSeconds"></param>
        /// <returns>IWebElement</returns>
        public static IWebElement WaitForDisplayed(this IWebDriver driver, By by, int timeOutinSeconds = 15)
        {
            try
            {
        ...
        /// <param name="timeOutInSeconds"></param>
        /// <returns></returns>
        public static IWebElement WaitForClickable(this IWebDriver driver, By by, int timeOutInSeconds = 15)
        {
            try
            {
                var element = driver.WaitForElement(by);

...
namespace MVPStudio.Framework.Extensions
{
    public static class WebElementExtension
    {
        ...
        public static void WaitForClickable(this IWebElement element, IWebDriver driver, int timeOutinSeconds = 15)
        {
            try
            {
        ...
        /// <param name="driver"></param>
        /// <param name="timeOutinSeconds"></param>
        public static void WaitForDisplayed(this IWebElement element, IWebDriver driver, int timeOutinSeconds = 15)
        {
            try
            {
                var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(timeOutinSeconds));
        ...
        /// <param name="driver"></param>
        /// <param name="timeOutinSeconds"></param>
        public static void WaitForTextLoaded(this IWebElement element, IWebDriver driver, int timeOutinSeconds = 15)
        {
            try
            {
                var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(timeOutinSeconds));

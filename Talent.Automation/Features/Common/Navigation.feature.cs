...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Navigate to jobs by Link")]
        [NUnit.Framework.CategoryAttribute("jobs")]
        [NUnit.Framework.CategoryAttribute("employer")]
        [NUnit.Framework.CategoryAttribute("recruiter")]
        [NUnit.Framework.TestCaseAttribute("employer", null)]
        [NUnit.Framework.TestCaseAttribute("recruiter", null)]
        public virtual void NavigateToJobsByLink(string role, string[] exampleTags)
        {
            string[] @__tags = new string[] {
                    "jobs",
                    "employer",
            ...
            string[] tagsOfScenario = @__tags;
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Navigate to jobs by Link", null, @__tags);
#line 41
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Navigate to talent feed Page by Link")]
        [NUnit.Framework.CategoryAttribute("talentfeed")]
        [NUnit.Framework.CategoryAttribute("employer")]
        [NUnit.Framework.CategoryAttribute("recruiter")]
        [NUnit.Framework.TestCaseAttribute("employer", null)]
        [NUnit.Framework.TestCaseAttribute("recruiter", null)]
        public virtual void NavigateToTalentFeedPageByLink(string role, string[] exampleTags)
        {
            string[] @__tags = new string[] {
                    "talentfeed",
                    "employer",
            ...
            string[] tagsOfScenario = @__tags;
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Navigate to talent feed Page by Link", null, @__tags);
#line 53
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line hidden
#line 55
 testRunner.And("I navigate to \'talent feed\' page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 56
 testRunner.Then("I should be navigated to \'talent feed\' page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        ...
        [NUnit.Framework.CategoryAttribute("jobpost")]
        [NUnit.Framework.CategoryAttribute("employer")]
        [NUnit.Framework.CategoryAttribute("recruiter")]
        [NUnit.Framework.TestCaseAttribute("employer", null)]
        [NUnit.Framework.TestCaseAttribute("recruiter", null)]
...
#line hidden
#line 67
 testRunner.And("I navigate to \'job post\' page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 68
 testRunner.Then("I should be navigated to \'job post\' page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
